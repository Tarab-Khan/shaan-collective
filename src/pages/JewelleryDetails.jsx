...
function JewelleryDetails() {
  ...
  const { jewelleryProducts } = useProducts();
  ...
  const [selectedSize, setSelectedSize] = useState(() => {
    return sessionStorage.getItem(`jewellery_size_${id}`) || "";
  });
  ...
  useEffect(() => {
    if (selectedSize) {
      sessionStorage.setItem(`jewellery_size_${id}`, selectedSize);
    }
  }, [selectedSize, id]);
  ...
  const wishlistId = `jewellery-${product.id}`;
        ...
        <div className="flex flex-col justify-center">
          ...
          <div>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              {(product.sizes || ["Standard", "Adjustable"]).map((size) => (

                <button
                  type="button"
                  key={size}
                  onClick={() => setSelectedSize(size)}
                  className={`h-12 min-w-24 px-4 border text-xs font-semibold transition ${
                    selectedSize === size
          ...
          <div className="mt-12 space-y-8 border-t border-[#dfba6a]/20 pt-8">
            ...
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-[#c4b28f]">
                {product.description || "Handcrafted luxury jewellery piece created with exquisite attention to detail and traditional craftsmanship."}
              </p>
            ...
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-[#c4b28f]">
                Carefully packaged in a signature box and prepared
                for secure delivery.
              </p>
