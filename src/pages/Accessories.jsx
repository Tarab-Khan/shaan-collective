...
function Accessories() {
  const { accessoryProducts, heroBanners } = useProducts();
  const heroImage = heroBanners?.accessories || heroBanners?.home;

  const storageKey = "accessories_catalog";
      ...
      <section className="relative overflow-hidden bg-[#070605] px-8 pb-24 pt-40 text-center border-b border-[#dfba6a]/20">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <p className="mx-auto mt-6 max-w-xl font-serif text-sm sm:text-base italic leading-7 text-[#e8dbbf]/90">
            Complete your look with carefully selected accessories designed for every celebration.
          </p>
        </div>
      </section>
